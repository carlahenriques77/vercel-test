          ...
          >
            <div className="flex flex-col gap-4 xl:gap-5">
              <h1 className="font-bold text-[1.75rem]">
                {callToActionData.data.attributes.CallToActionContact.Title}
              </h1>

              <p
                className={`font-bold xl:text-[1.125rem] sm:max-w-[600px] ${extraClassName}`}
              >
                {
                  callToActionData.data.attributes.CallToActionContact
